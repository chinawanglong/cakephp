<!--
    ...
    2. input 增加class => form_date 更改 type=>text
   <?= $this->form->input('signed', ['label'=>false, 'class' => 'form-control form_date', 'empty' => true, 'type' => 'text']); ?>

   3. css 样式 应bootstrap 版本，修复箭头图标，显示正常则不添加
...
<script type="text/javascript" src="<?= $this->Url->webroot('datetimepicker/bootstrap-datetimepicker.zh_CN.js')?>"></script>
